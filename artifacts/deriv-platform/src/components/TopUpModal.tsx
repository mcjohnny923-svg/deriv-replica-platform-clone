    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="bg-white dark:bg-[#151717] border-gray-200 dark:border-[#323738] text-gray-900 dark:text-white sm:max-w-md p-0 overflow-hidden">
        <DialogHeader className="px-6 pt-6 pb-4 border-b border-gray-200 dark:border-[#323738] space-y-1">
          <DialogTitle className="text-xl font-bold text-gray-900 dark:text-white">Top Up Funds</DialogTitle>
          <DialogDescription className="text-gray-400 dark:text-gray-500 dark:text-gray-400">Choose payment method</DialogDescription>
        </DialogHeader>
        ...
        <div className="p-4 space-y-3">
          ...
          >
            ...
            <div className="flex-1 text-left">
              <div className="text-gray-900 dark:text-white font-semibold">M-Pesa</div>
              <div className="text-gray-400 dark:text-gray-500 dark:text-gray-400 text-sm">Mobile Money</div>
            </div>
          ...
          >
            ...
            <div className="flex-1 text-left">
              <div className="text-gray-900 dark:text-white font-semibold">Payment agent</div>
              <div className="text-gray-400 dark:text-gray-500 dark:text-gray-400 text-sm">Mobile Money</div>
            </div>
            <ChevronRight className="h-5 w-5 text-gray-400 dark:text-gray-500" />
          </button>
          ...
          >
            ...
            <div className="flex-1 text-left">
              <div className="text-gray-900 dark:text-white font-semibold">Credit / Debit Card</div>
              <div className="text-gray-400 dark:text-gray-500 dark:text-gray-400 text-sm">Visa, Mastercard</div>
            </div>
            <ChevronRight className="h-5 w-5 text-gray-400 dark:text-gray-500" />
          </button>
        </div>
