        ...
        <div className="relative">
          ...
          >
            <div className="text-left leading-tight">
              <div className="text-[10px] text-gray-400 capitalize">{activeAccount}</div>
            ...
            <div className="absolute right-0 top-full mt-1 w-60 bg-[#323738] border border-[#414647] rounded-lg shadow-lg z-50 overflow-hidden">
              ...
              >
                <div className="text-left">
                  ...
                  <div className="text-xs text-gray-400">USD 10,000.00</div>
                </div>
                {activeAccount === 'demo' && <Check className="h-4 w-4 text-red-500" />}
              </button>
              <div className="border-t border-[#414647]" />
              <button
                onClick={() => {
              ...
              >
                <div className="text-left">
                  <div className="text-sm font-medium text-white">Real</div>
                  <div className="text-xs text-gray-400">USD 0.00</div>
                </div>
                {activeAccount === 'real' && <Check className="h-4 w-4 text-red-500" />}
              </button>
            </div>
          )}
        </div>
