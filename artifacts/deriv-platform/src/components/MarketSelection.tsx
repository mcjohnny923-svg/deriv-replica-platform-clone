                ...
                {markets.map((market) => (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div>
                        <div className="text-gray-900 dark:text-white font-medium">{market.symbol}</div>
                        <div className="text-gray-400 dark:text-gray-500 dark:text-gray-400 text-sm">{market.name}</div>
                      </div>
                      <div className="text-right">
                        <div className="text-gray-900 dark:text-white">{market.price}</div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-6 gap-4">
        {markets.slice(0, 6).map((market) => (
          ...
          >
            ...
            <div className="text-xs text-gray-900 dark:text-white mt-1">{market.price}</div>
